  ...
  const handleSave = async () => {
    if (editing) {
      ...
      if (error) {
        ...
        setDishes(
          dishes.map((dish) => (dish.id === editing.id ? editing : dish))
        );
        setEditing(null);
      }
      setLoading(false);
      ...
      <div className="bg-gray-800 rounded-lg shadow-md p-6 mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <select
            ...
            onChange={(e) =>
              setNewDish({ ...newDish, cuisine: e.target.value })
            }
          ...
          <input
            ...
            onChange={(e) =>
              setNewDish({ ...newDish, yt_link: e.target.value })
            }
            className="px-4 py-2 bg-gray-700 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
          />
          <div className="flex items-center">
            <input
              ...
              onChange={(e) =>
                setNewDish({ ...newDish, prep_required: e.target.checked })
              }
              className="mr-2"
            />
              ...
              <div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setEditing({ ...editing, yt_link: e.target.value })
                    }
                    className="px-3 py-2 bg-gray-700 border border-gray-600 rounded text-white focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent"
                  />
                  <div className="flex items-center">
                    <input
                      ...
                      onChange={(e) =>
                        setEditing({
                          ...editing,
                          prep_required: e.target.checked
                        })
                      }
                      className="mr-2"
                    />
                ...
                <textarea
                  ...
                  onChange={(e) =>
                    setEditing({ ...editing, recipe: e.target.value })
                  }
                  className="w-full px-3 py-2 bg-gray-700 border border-gray-600 rounded text-white focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent mb-4"
                  rows={4}
                />
